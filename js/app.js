...
// import displacement from '../img/8.jpg';
import text from '../img/THREE-TEXT.jpg';
  ...
  addObjects() {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        texture1: { value: null },
        text: { value: new THREE.TextureLoader().load(text) },
        // displacement: { value: new THREE.TextureLoader().load(displacement) },
